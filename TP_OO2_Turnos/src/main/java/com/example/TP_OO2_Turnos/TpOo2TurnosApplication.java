...
public class TpOo2TurnosApplication {
    ...
    public CommandLineRunner loadData(IUsuarioRepository usuarioRepository,IServicioRepository servicioRepository,ILugarRepository lugarRepository,
    		...
    		IUserRoleRepository userRoleRepository, TurnoService turnoService, DiaService diaService, DisponibilidadService disponibilidadService, 
    		LugarService lugarService, ServicioService servicioService) {
        return args -> {
        	
        	
            // Crear empleados de prueba
        	Empleado empleado1;
        	if (!userRepository.existsByEmail("empleado1@empresa.com")) {
        	    User user1 = new User();
        	    ...
        	    empleado1 = (Empleado) usuarioRepository.findByDni(12345678).get();
        	}

        	Empleado empleado2;
        	if (!userRepository.existsByEmail("empleado2@empresa.com")) {
        	    User user2 = new User();
        	    ...
        	    empleado2 = (Empleado) usuarioRepository.findByDni(23456789).get();
        	}

        	Cliente cliente1;
        	if (!userRepository.existsByEmail("cliente1@gmail.com")) {
        	    User user3 = new User();
        	    ...
        	    cliente1 = (Cliente) usuarioRepository.findByDni(34567890).get();
        	}

        	Cliente cliente2;
        	if (!userRepository.existsByEmail("cliente2@gmail.com")) {
        	    User user4 = new User();
        	    ...
        	    cliente2 = (Cliente) usuarioRepository.findByDni(45678901).get();
        	}
	
            
        	Servicio servicio1 = servicioService.registrarServicioSiNoExiste("Limpieza dental", 15);
        	Servicio servicio2 = servicioService.registrarServicioSiNoExiste("Operacion conducto", 30);

        	// Crear lugares solo si no existen
        	Lugar lugar1 = lugarService.registrarLugarSiNoExiste("pedro dreyer 26", "Temperley");
        	Lugar lugar2 = lugarService.registrarLugarSiNoExiste("Rojas 123", "Lomas de zamora");

        	// Crear conjunto de días laborables
        	...
        	// Crear disponibilidades con validación
        	Disponibilidad dis1 = disponibilidadService.registrarDisponibilidadSiNoExiste(
        			LocalTime.of(8, 0), LocalTime.of(17, 0), lugar1, servicio1, dl);

        	Disponibilidad dis2 = disponibilidadService.registrarDisponibilidadSiNoExiste(
        		    LocalTime.of(9, 0), LocalTime.of(19, 0), lugar2, servicio2, dl);
        	
        	//crear dia
        	Dia dia1 = diaService.registrarDiaSiNoExiste(LocalDate.of(2025, 6, 7), dis1);
        	Dia dia2 = diaService.registrarDiaSiNoExiste(LocalDate.of(2025, 6, 10), dis1);
        	Dia dia3 = diaService.registrarDiaSiNoExiste(LocalDate.of(2025, 6, 17), dis2);
            
            //crear turno
        	Turno turno1 = turnoService.registrarTurnoSiNoExiste(cliente1, empleado1, dia1, LocalTime.of(15, 0));
            Turno turno2 = turnoService.registrarTurnoSiNoExiste(cliente1, empleado2, dia2, LocalTime.of(11, 0));
            Turno turno3 = turnoService.registrarTurnoSiNoExiste(cliente2, empleado1, dia3, LocalTime.of(13, 0));
        };
    }
