...
import com.example.TP_OO2_Turnos.models.EmailFileModel;
...
public class MailController {
    ...
    public ResponseEntity<?> receiveRequestEmail(@ModelAttribute("email") EmailModel emailDTO){
    ...
    public ResponseEntity<?> receiveRequestEmailWithFile(@ModelAttribute EmailFileModel emailFileDTO){
